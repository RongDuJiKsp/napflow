...
const submitChange = async (data: AccountChangeNicknameReq) => await jsonQ.Post<NullResp>('/account/change-nickname', data)
...
export const useUpdateNickname = () => {
  ...
  const handleSubmit = useSubmitZod(formValue, ZodCheckAccountChangeNicknameReq, submitChange, { successText: '修改昵称成功', errorText: '提交失败', afterSuccess: resetForm })
