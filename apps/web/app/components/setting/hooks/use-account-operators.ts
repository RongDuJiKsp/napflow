...
import type { AccountDisableReqType, AccountUpDownGradeReqType } from '@shared/data-transfer/account/account'
import { AccountDisableReq, AccountUpDownGradeReq } from '@shared/data-transfer/account/account'
import { App } from 'antd'
import { useCallback, useState } from 'react'
import z from 'zod'

export const useAccountOperators = () => {
