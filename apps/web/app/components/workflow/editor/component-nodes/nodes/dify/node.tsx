...
const DifyNode: ComponentNodeFc<DifyData> = ({ id, data }) => {
  ...
  return (
    <div className="flex flex-col gap-1 relative min-w-40">
      ...
      <div className="flex items-center justify-between gap-2 text-xs px-2 py-1 rounded bg-white/60 border border-pink-100">
        <span className="text-purple-500 font-medium">API 地址</span>
        <span className="truncate text-gray-500 max-w-28">
      ...
      {isChatflow ? (
        <div className="flex flex-col gap-0.5 text-xs px-2 py-1 rounded bg-white/60 border border-pink-100">
          <span className="text-purple-500 font-medium">请求内容</span>
          {data.query ? (
        ...
        <div className="flex items-center justify-between gap-2 text-xs px-2 py-1 rounded bg-white/60 border border-pink-100">
          <span className="text-purple-500 font-medium">输入变量</span>
