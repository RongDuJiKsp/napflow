...
import { getIterateStartOutputVar, useComponentNodeEnv } from '../../../hooks/use-component-node-env'
...
export const useIterateStartOutputVars = (id: string): Var[] => {
  ...
  const parentIteratorNode = safeAssertWorkflowNodeAsComponentNode(ComponentNodesEnum.Iterate, parentNode)
