...
export const useSubmitZodFn = <Req, Res extends BaseRespType<unknown>>(
  schema: z.ZodType<Req>,
  submit: (data: Req) => Promise<Res>,
  {
    successText = ' 表单提交成功',
    errorText = '表单校验失败',
    afterSuccess,
...
export const useSubmitZod = <Req, Res extends BaseRespType<unknown>>(
  data: Req,
  schema: z.ZodType<Req>,
  submit: (data: Req) => Promise<Res>,
  config?: CommonSubmitConig,
) => {
