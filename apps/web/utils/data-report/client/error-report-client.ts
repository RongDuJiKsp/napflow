...
export const extractErrorLike = (value: unknown): ExtractedErrorLike => {
...
export const reportInternErrorPayloadCore = (payload: InternErrorReportPayload) => {
  const payloadText = JSON.stringify(payload)
  if (!sendByBeacon(payloadText)) sendByFetch(payloadText)
}

export const reportClientErrorCore = ({
  source,
  error,
  message,
  stack,
