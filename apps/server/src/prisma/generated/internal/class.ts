...
/**
  ...
  /**
   * `prisma.workflowAppPublishMeta`: Exposes CRUD operations for the **WorkflowAppPublishMeta** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more WorkflowAppPublishMetas
    * const workflowAppPublishMetas = await prisma.workflowAppPublishMeta.findMany()
    * ```
    */
  get workflowAppPublishMeta(): Prisma.WorkflowAppPublishMetaDelegate<ExtArgs, { omit: OmitOpts }>;
}
