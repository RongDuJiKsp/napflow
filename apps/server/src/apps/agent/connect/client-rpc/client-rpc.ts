...
export type ClientRPCMethods = typeof CLIENT_RPC_METHODS & Record<string, RPCMethodItem>
export type ClientRPCHandler<K extends keyof ClientRPCMethods> = (...args: z.input<ClientRPCMethods[K]['request']>) => Promise<z.output<ClientRPCMethods[K]['response']>>
/**
